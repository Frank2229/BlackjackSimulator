                ...
                if (Objects.equals(hand.getCards().getFirst(), hand.getCards().get(1)) && player.getHands().size() < rules.getMaxSplitHands()) {
                    if (hand.getCards().getFirst() == 2) {
                        ...
                        if (dealerHand.getCards().getFirst() <= 7) {
                            ...
                            if (rules.getTotalDecks() == 1) {
                                if (rules.isSurrender() && player.getHands().size() == 1)
                        ...
                        if (dealerHand.getCards().getFirst() == 7 || dealerHand.getCards().getFirst() == 10)
                            isRoundOver = true;
                        else if (dealerHand.getCards().getFirst() == 11) {
                        ...
                        player.getStrategy().addCardToCount(deck.getShoe().peek(), deck.getShoe().size());
                        deck.dealCard(hand);
                        if (hand.getCards().get(1) != 11 || (hand.getCards().get(1) == 11 && !rules.isRSA()))
                            isRoundOver = true;
                    }
                    ...
                    if (hand.getValue() <= 7) deck.dealCard(hand);
                        ...
                        if (dealerHand.getCards().getFirst() >= 4 && dealerHand.getCards().getFirst() <= 6)
                            isRoundOver = true;
                        else {
                            player.getStrategy().addCardToCount(deck.getShoe().peek(), deck.getShoe().size());
                            deck.dealCard(hand);
                        ...
                        if (dealerHand.getCards().getFirst() == 11 && !rules.isS17() && rules.isSurrender() && player.getHands().size() == 1)
                            player.surrender(currentHand, deck);
                        isRoundOver = true;
                    } else isRoundOver = true;
                }
